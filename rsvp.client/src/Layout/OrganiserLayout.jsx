...
const OrganiserLayout = () => {
  ...
  const sidebarItems = [
    {
      group: "Main",
      items: [
        { name: "Dashboard", icon: MdDashboard, path: "/organiser/" },
        { name: "Events", icon: MdEmojiEvents, path: "/organiser/events" },
        { name: "Members", icon: MdGroups, path: "/organiser/members" },
      ],
    },
    {
      group: "Other",
      items: [
        { name: "Settings", icon: MdSettings, path: "/organiser/settings" },
        { name: "Help", icon: MdHelp, path: "/organiser/help" },
      ],
    },
  ];
  ...
  const LogoSection = ({ collapsed, isMobile }) => (
    <Link
      ...
      `}
    >
      <FaStore className="text-2xl text-[#0897FF] shrink-0" />
      {(!collapsed || isMobile) && (
        <span className="font-bold text-xl text-gray-800">RSVP</span>
      )}
    </Link>
  );
    ...
    return (
      <Link
        ...
        className={`
          ...
          ${
            isActive
              ? "bg-gradient-to-r from-[#0897FF] to-[#0897FF] text-white shadow-md"
      ...
      >
        <Icon
          className={`
            ...
            ${isActive ? "text-white" : "text-gray-500 group-hover:text-[#0897FF]"}
        ...
        {(!isCollapsed || isMobile) && (
          <span
            className={`
            text-sm font-medium
            ${isActive ? "text-white" : "text-gray-700 group-hover:text-[#0897FF]"}
            transition-colors duration-200
          `}
          >
            {item.name}
          ...
          {!isCollapsed ? (
            <>
              <div className="flex flex-col gap-2 text-sm text-gray-500 mb-4">
                <Link to="#" className="hover:text-[#0897FF] transition-colors">
                  Terms & Conditions
                </Link>
                <Link to="#" className="hover:text-[#0897FF] transition-colors">
                  Privacy Policy
              ...
              <p className="text-xs text-gray-400">© 2025 RSVP</p>
            </>
          ) : (
